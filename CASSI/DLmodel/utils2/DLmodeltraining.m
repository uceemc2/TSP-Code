function [Phi_rgb_p,x_rgb_p,y_rgb_p,Phi_hsi,x_hsi_p, y_hsi_p] = DLmodeltraining(filename)

% load RGB
%filename = 'scene2'; % Training data 2,3,4,6,7,8
mea_HSI = 2;
mea_rgb = 'rgb';
...
% Load Phi2 for both training and testing
% load('DL_CASSIPhi2.mat');
% load('DL_CASSIPhi2_2imgs.mat');
load('DL_CASSIPhi2_2imgs_002.mat');

% 1) Generate Phi2 (CASSI projection kernel for compressing HSI)
