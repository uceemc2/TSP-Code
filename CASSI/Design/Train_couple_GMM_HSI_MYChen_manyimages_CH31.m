...
% xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx image new 
image_rgb_new  = [image_rgb_1 image_rgb_3 image_rgb_4 image_rgb_6 image_rgb_7 image_rgb_8];
image_hsi_new  = [image_hsi_1 image_hsi_3 image_hsi_4 image_hsi_6 image_hsi_7 image_hsi_8];
...
savename = ['Model_RGB_256_HSI_256_K30_TEST_FRO_S2_' num2str(PatchSize) '_Ch' num2str(Ch) '.mat'];
save(savename,...
    '-v7.3', 'Mu','Sig','pai',...
