...
% here we use non-overlapping /overlapping patches
olp_lar = 4;
olp = 2; 
...
% xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx image 5 xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
filename = 'scene7';
addpath(filename);
...
image_rgb_5 = image_rgb;
image_hsi_5 = image_hsi;
...
image_rgb_new  = [image_rgb_1 image_rgb_2 image_rgb_3 image_rgb_4 image_rgb_5 image_rgb_6];
image_hsi_new  = [image_hsi_1 image_hsi_2 image_hsi_3 image_hsi_4 image_hsi_5 image_hsi_6];
...
savename = ['Model_RGB_512_HSI_256_K20_overlapping_patches' num2str(PatchSize) '_Ch' num2str(Ch) '.mat'];
save(savename,...
    '-v7.3', 'Mu','Sig','pai',...
