% =========================================================================
% Super-resolving RGB images with NIR images as guidance information.
...
clear; close all
addpath('CASSI/ksvd');
addpath('CASSI/ksvd/ksvdbox');
addpath('CASSI/ksvd/ksvdbox/private_ccode');
addpath('CASSI/ksvd/ompbox');
% addpath('../TestImages_Multispectral');
% addpath('../TrainImages_Multispectral');
addpath('CASSI/DLmodel/utils')
addpath('CASSI/DLmodel/utils2')
...
% 	paramsCDL = rmfield(paramsCDL,'Ycell');
	...
	for i = 1: length(TrainImgNo)
		ImgName = ['CASSI/DLmodel/scene', num2str(TrainImgNo(i))];
