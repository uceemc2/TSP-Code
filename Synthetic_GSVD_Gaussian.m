...
% Gaussian class K_1=K_2=1
K1=1; K2=1;

% prior probabilities (watch out when they are equal to zero and the
% ordering)
pcvett=rand(K1*K2,1);
...
for nn=1:length(vettM1)
    ...
    % generation of the random measurment matrices
    Phi1=Phi01(1:M1,:);
...
for i = 1:itotal
    ...
    % generation of the designed measurment matrices
